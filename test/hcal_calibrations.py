...
plotDir = '/afs/cern.ch/user/t/truggles/www/Phase-II/hcal_calibrations/aug13v3_noPU/'
if not os.path.exists( plotDir ) : os.makedirs( plotDir )


def make_2d( t, to_plot, name ) :
    #h = ROOT.TH2F(name , name, 50, 0, 100, 90, -1, 30)
    h = ROOT.TH2F(name , name, 10, 0, 100, 50, 0, 2)
...
make_2d( t, 'cluster_hovere:gen_pt', 'hist_hovere' )
