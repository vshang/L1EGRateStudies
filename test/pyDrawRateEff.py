...
if __name__ == '__main__' :
    ...
    effMap = {
        'newAlgEtaHist' : ('L1EGamma_Crystal', 'analyzer/dyncrystalEG_efficiency_eta'),
        'newAlgPtHist' : ('L1EGamma_Crystal', 'analyzer/dyncrystalEG_efficiency_pt'),
        'newAlgDRHist' : ('L1EGamma_Crystal', 'analyzer/dyncrystalEG_deltaR'),
        'oldAlgEtaHist' : ('Original L2 Algorithm', 'analyzer/SLHCL1ExtraParticles:EGamma_efficiency_eta'),
        'oldAlgPtHist' : ('Original L2 Algorithm', 'analyzer/SLHCL1ExtraParticles:EGamma_efficiency_pt'),
        'oldAlgDRHist' : ('Original L2 Algorithm', 'analyzer/SLHCL1ExtraParticles:EGamma_deltaR'),
        'dynAlgEtaHist' : ('LLR Alg.', 'analyzer/SLHCL1ExtraParticlesNewClustering:EGamma_efficiency_eta'),
        'dynAlgPtHist' : ('LLR Alg.', 'analyzer/SLHCL1ExtraParticlesNewClustering:EGamma_efficiency_pt'),
        'dynAlgDRHist' : ('LLR Alg.', 'analyzer/SLHCL1ExtraParticlesNewClustering:EGamma_deltaR'),
        'run1AlgEtaHist' : ('Run 1 Alg.', 'analyzer/l1extraParticles:All_efficiency_eta'),
        'run1AlgPtHist' : ('Run 1 Alg.', 'analyzer/l1extraParticles:All_efficiency_pt'),
        'run1AlgDRHist' : ('Run 1 Alg.', 'analyzer/l1extraParticles:All_deltaR'),
        'UCTAlgEtaHist' : ('Phase 1 TDR', 'analyzer/l1extraParticlesUCT:All_efficiency_eta'),
        'UCTAlgPtHist' : ('Phase 1 TDR', 'analyzer/l1extraParticlesUCT:All_efficiency_pt'),
...
#    }
    ...
    #dir = rateFile.Get('analyzer')
    #print "dir.ls"
    #dir.ls()
    #print "dir.getlistofkeys"
    #dKeys = dir.GetListOfKeys()
    #for key in dKeys :
    #    print key
    #    print key.GetName()
    #    print key.GetTitle()
    ...
    drawEfficiency([effHists['newAlgEtaHist'], effHists['UCTAlgEtaHist'], effHists['dynAlgEtaHist']], c1, 1.2, xrange, False, [-2.5, 2.5])
