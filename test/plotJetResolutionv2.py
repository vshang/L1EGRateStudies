...
cut_endcap = 'abs(genJet_eta)<1.5 && genJet_pt>20 && (towerEt/tauEt)>0.3'
...
legend.AddEntry(hist_endcap, '#splitline{|#eta^{'+genObj+'}| < 1.5 &}{(seed TT p_{T}/tau p_{T}) > 0.3}', 'lpe')
if not doTau:
...
canvas.SaveAs(saveDirectory + file + '_tauEt_isoTau0p3.png')
