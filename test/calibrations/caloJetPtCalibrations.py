...
def make_em_fraction_calibrations( fName, cut, plotBase ) :
    ...
    f_out = ROOT.TFile('new_calibrations2.root','RECREATE')
...
if __name__ == '__main__' :
    ...
    if make_calibrations :
        make_em_fraction_calibrations( base+jetsF0, cut, plotDir )
