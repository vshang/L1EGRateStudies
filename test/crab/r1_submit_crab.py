...
dataMap['minBias-PU200_13_1X'] = {'das' : '/MinBias_TuneCP5_14TeV-pythia8/Phase2Spring23DIGIRECOMiniAOD-PU200_Trk1GeV_131X_mcRun4_realistic_v5-v1/GEN-SIM-DIGI-RAW-MINIAOD'}
...
#dataMap['VBFHTT-PU200_13_1X'] = {'das' : '/VBFHToTauTau_M-125_TuneCP5_14TeV-powheg-pythia8/Phase2Spring23DIGIRECOMiniAOD-PU200_Trk1GeV_131X_mcRun4_realistic_v5-v1/GEN-SIM-DIGI-RAW-MINIAOD'}
...
#dataMap['QCD-PU200_13_1X'] = {'das' : '/QCD_Pt-15To3000_TuneCP5_Flat_14TeV-pythia8/Phase2Spring23DIGIRECOMiniAOD-PU200_Trk1GeV_131X_mcRun4_realistic_v5-v2/GEN-SIM-DIGI-RAW-MINIAOD'}
...
if True:
    ...
    for k in dataMap.keys() :
        ...
        config.General.requestName = '20240404_%s_r1_CMSSW_14_0_0_pre3_GCTJets_calib3GeVmaxTT12jets' % k
        config.JobType.psetName        = 'r1_crabby_jets.py'
        config.Data.inputDataset = dataMap[ k ][ 'das' ]
        config.Data.inputBlocks = [
            #dataMap[ k ][ 'das' ] + '#0b9c9825-909a-4fe3-bb4b-80a429017a82', v27 minBias
            dataMap[ k ][ 'das' ] + '#05b54fd2-7ea8-4305-b1ab-431533cfea25', #13_1X minBias
            #dataMap[ k ][ 'das' ] + '#9fe2d9e5-a326-499e-8c07-2e4e72f8363f', #13_1X VBF
            #dataMap[ k ][ 'das' ] + '#42274f2e-9457-44d1-bab0-cfd84c71478b', #13_1X QCD
        ]
