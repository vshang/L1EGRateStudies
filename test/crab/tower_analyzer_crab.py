...
process.analyzer = cms.EDAnalyzer("L1TowerAnalyzer",
    ...
    puThresholdHcal = cms.double(2.0), # Default is 3 GeV
    puThresholdL1eg = cms.double(2.0), # Default is 4 GeV
    puThresholdHGCalEMMin = cms.double(0.5), # Default is 1 GeV
    puThresholdHGCalEMMax = cms.double(1.0), # Default is 1.5 GeV
    puThresholdHGCalHadMin = cms.double(0.5), # Default is 0.5 GeV
    puThresholdHGCalHadMax = cms.double(1.0), # Default is 1 GeV
    puThresholdHFMin = cms.double(7.0), # Default is 4 GeV
    puThresholdHFMax = cms.double(9.0), # Default is 10.0 GeV
