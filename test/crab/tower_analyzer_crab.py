...
process.analyzer = cms.EDAnalyzer("L1TowerAnalyzer",
    ...
    puThresholdL1eg = cms.double(4.0), # Default is 4 GeV
    puThresholdHGCalEMMin = cms.double(1.0), # Default is 1 GeV
    puThresholdHGCalEMMax = cms.double(1.5), # Default is 1.5 GeV
    puThresholdHGCalHadMin = cms.double(0.5), # Default is 0.5 GeV
    puThresholdHGCalHadMax = cms.double(1.0), # Default is 1 GeV
    puThresholdHFMin = cms.double(4.0), # Default is 4 GeV
    puThresholdHFMax = cms.double(10.0), # Default is 10.0 GeV
