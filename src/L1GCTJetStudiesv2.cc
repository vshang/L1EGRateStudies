// -*- C++ -*-
//
// Package:     L1GCTJetStudiesv2
// Class:        L1GCTJetStudiesv2
// 
/**\class L1GCTJetStudiesv2 L1GCTJetStudiesv2.cc L1Trigger/L1EGRateStudies/src/L1GCTJetStudiesv2.cc
...
// class declaration
//
class L1GCTJetStudiesv2 : public edm::one::EDAnalyzer<edm::one::SharedResources, edm::one::WatchRuns, edm::one::WatchLuminosityBlocks> {
    ...
    public:
        explicit L1GCTJetStudiesv2(const edm::ParameterSet& iConfig);
        ~L1GCTJetStudiesv2();
...
//
L1GCTJetStudiesv2::L1GCTJetStudiesv2(const edm::ParameterSet& iConfig) :
    ...
    puToken_(consumes<std::vector<PileupSummaryInfo>>(iConfig.getParameter<edm::InputTag>("puSrc")))
{
    ...
    tree->Branch("ecalEt", &treeinfo.ecalEt);
    tree->Branch("EMfrac", &treeinfo.EMfrac);
...
L1GCTJetStudiesv2::~L1GCTJetStudiesv2()
{
...
void
L1GCTJetStudiesv2::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
    if (debug) printf("Starting L1GCTJetStudiesv2 Analyzer\n");
    using namespace edm;
  ...
  if (!doRate) {
    ...
    if (debug) printf("Ending L1GCTJetStudiesv2 Analyzer\n");
...
void 
L1GCTJetStudiesv2::beginJob()
{
}

// ------------ method called once each job just after ending the event loop  ------------
void 
L1GCTJetStudiesv2::endJob() 
{
}

// ------------ method called when starting to processes a run  ------------
void 
L1GCTJetStudiesv2::beginRun(edm::Run const& run, edm::EventSetup const& es)
{
...
void 
L1GCTJetStudiesv2::endRun(edm::Run const&, edm::EventSetup const&)
{
}
...
void 
L1GCTJetStudiesv2::beginLuminosityBlock(edm::LuminosityBlock const&, edm::EventSetup const&)
{
}
...
void 
L1GCTJetStudiesv2::endLuminosityBlock(edm::LuminosityBlock const&, edm::EventSetup const&)
{
}

// ------------ method fills 'descriptions' with the allowed parameters for the module  ------------
void
L1GCTJetStudiesv2::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
...
void
L1GCTJetStudiesv2::fill_tree(const l1tp2::Phase2L1CaloJet& caloJet) {
    treeinfo.jetEt = caloJet.jetEt();
    treeinfo.tauEt = caloJet.tauEt();
    treeinfo.ecalEt = caloJet.ecalEt();
    treeinfo.EMfrac = caloJet.EMfrac();
...
void
L1GCTJetStudiesv2::fill_tree_null() {
...
DEFINE_FWK_MODULE(L1GCTJetStudiesv2);
