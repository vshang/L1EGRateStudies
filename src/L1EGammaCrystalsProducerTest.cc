...
/*
void L1EGCrystalClusterProducerTest::beginRun(const edm::EventSetup & c){
...
unsigned int L1EGCrystalClusterProducerTest::getMatchedClusterIndex(l1slhc::L1EGCrystalCluster& egxtals, float& eta, float& phi, float& dr_min) {
  dr_min = 999.9;
